    ...
    var b={
        init:function(d,e){
            return this.each(function(){
                ...
                f.html('<span class="before"></span><span class="uploadify-button-text">'+j.buttonText+'</span><span class="after"></span>').css({
                    height:j.height+"px",
                    "line-height":j.height+"px",
                    width:j.width+"px" // little trick
                    });
                l.append(f);
                c("#"+i.movieName).css({
                    position:"absolute",
...
if(c.inArray("onSelect",h.overrideEvents)<0){
    c("#"+h.queueID).append('<div id="'+g.id+'" class="uploadify-queue-item"><table><tbody><tr><td class="img"><span class="fileName">'+j+' </span></td><td class="date"></td></tr><tr><td colspan="2"><div class="uploadify-progress"><div class="uploadify-progress-bar"><!--Progress Bar--></div> </div></td></tr></tbody></div>');
}
